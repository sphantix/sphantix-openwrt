...
static const struct spi_device_id m25p_ids[] = {
	...
	{ "gd25q256c", INFO(0xc84019, 0, 64 * 1024, 512, 0) },  //Add by hangxu 2014/12/8
...
static void m25p_shutdown(struct spi_device *spi)
{
    ...
    pr_debug("enter, jedec_id = %02X\n",JEDEC_MFR(info->jedec_id));
...
static struct spi_driver m25p80_driver = {
	...
	.probe	= m25p_probe,
	.remove	= m25p_remove,
    .shutdown = m25p_shutdown, //Add by hangxu 2014/12/2
