...
# Add by hangxu 2015/8/5
include $(TOPDIR)/include/customer.mk
# Add by hangxu End
...
BIN_DIR:=$(if $(call qstrip,$(CONFIG_BINARY_FOLDER)),$(call qstrip,$(CONFIG_BINARY_FOLDER)),$(TOPDIR)/bin/$(BOARD)/$(PROJECT))
